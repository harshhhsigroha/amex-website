        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: HeadphonesIcon, title: 'Round-the-Clock Support and Transparent Services', desc: 'Readily-available expert support with full transparency - no hidden fees, no surprises - so you can focus on delivering exceptional guest experiences.' },
